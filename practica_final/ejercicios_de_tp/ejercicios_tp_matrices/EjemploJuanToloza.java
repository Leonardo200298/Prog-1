...
public class EjemploJuanToloza {
    ...
    public static void main(String[] args) {
        int[][] matint = {
                { 0, 2, 1, 8, 0, 2, 9, 5, 0, 7, 4, 1, 0, 1, 0, 0 },
        ...
        while (ini < M) {
            ...
            if (ini < M) {
                ...
                if (longitud > TOPE) {
                    ...
                    // aca debes actualizar el fin a ini dado que borras toda la secuencia, si
                    // borras solo una parte el fin deberías restarle la cantidad de elementos
                    // eliminados
                    fin = ini;
                }
            }
